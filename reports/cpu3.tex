...
\section{PC Adder}
\lstinputlisting[language=python]{components/ALU/PC_Adder.py}
\subsection{Test-bench}
\lstinputlisting[language=python]{components/ALU/PC_Adder_test.py}
...
\lstinputlisting{reports/PC_Adder.txt}
